...
public class StateItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOnEnterActionPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the On Enter Action feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOnEnterActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_State_onEnterAction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_State_onEnterAction_feature", "_UI_State_type"),
				 TfsmPackage.Literals.STATE__ON_ENTER_ACTION,
				 true,
				 false,
				 false,

 ...
 *   <li>{@link org.gemoc.sample.tfsm.impl.StateImpl#getOnEnterAction <em>On Enter Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends NamedElementImpl implements State {
	...
	/**
	 * The default value of the '{@link #getOnEnterAction() <em>On Enter Action</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String ON_ENTER_ACTION_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getOnEnterAction() <em>On Enter Action</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getOnEnterAction()
	 * @generated
	 * @ordered
	 */
	protected String onEnterAction = ON_ENTER_ACTION_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setOnEnterAction(String newOnEnterAction) {
		String oldOnEnterAction = onEnterAction;
		onEnterAction = newOnEnterAction;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.STATE__ON_ENTER_ACTION, oldOnEnterAction, onEnterAction));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TfsmPackage.STATE__ON_ENTER_ACTION:
				return getOnEnterAction();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case TfsmPackage.STATE__INCOMING_TRANSITIONS:
				...
				return;
			case TfsmPackage.STATE__ON_ENTER_ACTION:
				setOnEnterAction((String)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case TfsmPackage.STATE__INCOMING_TRANSITIONS:
				...
				return;
			case TfsmPackage.STATE__ON_ENTER_ACTION:
				setOnEnterAction(ON_ENTER_ACTION_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case TfsmPackage.STATE__ON_ENTER_ACTION:
				return ON_ENTER_ACTION_EDEFAULT == null ? onEnterAction != null : !ON_ENTER_ACTION_EDEFAULT.equals(onEnterAction);
		}
